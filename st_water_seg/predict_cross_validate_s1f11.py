...
from st_water_seg.predict_s1f11 import predict
...
if __name__ == '__main__':
    ...
    #     print(folder)
    #     path_F1_image = glob(root_folder+'/'+folder+'/predictions_coincide/*/*/*/ranked_images_F1-score.txt')
    #     path_F1_region = glob(root_folder+'/'+folder+'/predictions_coincide/*/*/*/ranked_regions_F1-Score.txt')
    #     path_iou_image = glob(root_folder+'/'+folder+'/predictions_coincide/*/*/*/ranked_images_mIoU.txt')
    #     path_iou_region = glob(root_folder+'/'+folder+'/predictions_coincide/*/*/*/ranked_regions_iou.txt')
